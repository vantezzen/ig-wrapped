...
function Terms() {
  return (
    <LegalPage>
      <Head>
        <title>Wrapped for Instagram - Terms of Service</title>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          ...
          for Instagram ("Service"), a web application that provides
          personalized statistics on your Instagram usage. The Service is
          provided by Wrapped for Instagram LLC ("we", "us" or "our").
        </p>
        <p>
        ...
        <p>
          The Service relies on data from Instagram's API and other third-party
